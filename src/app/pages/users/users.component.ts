...
@Component({
  selector: 'app-users',
  imports: [RouterLink, MatCardModule, NgxEditorModule, NewLeadsComponent, ActiveLeadsComponent, LeadConversionComponent, RevenueGrowthComponent, MatTabsModule, MatIconModule, MatTooltipModule, MatCheckboxModule, NgIf, MatPaginatorModule, MatTableModule, MatButtonModule, MatDialogModule, FormsModule, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatSelectModule],
...
export class UsersComponent {
  ...
  displayedColumns: string[] = ['select', 'id', 'name', 'email', 'phone', 'designation', 'role', 'password', 'status','action'];
...
ngOnDestroy(): void {
  ...
  fetchUsersList(page: number, limit: number) {
    ...
    //       this.dataSource = new MatTableDataSource<PeriodicElement>(this.usersList);
  ...
  openUserForm(user?: PeriodicElement) {
    ...
    if (user) {
      ...
      this.userForm.reset({
        role: 'user',
        status: 'active',
        action: { view: 'visibility', edit: 'edit', createTask: 'add_task', delete: 'delete' },
      });
